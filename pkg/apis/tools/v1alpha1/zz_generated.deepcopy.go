...
func (in *ApplicationAssemblerSpec) DeepCopyInto(out *ApplicationAssemblerSpec) {
	*out = *in
	if in.HubComponents != nil {
		in, out := &in.HubComponents, &out.HubComponents
	...
	if in.ManagedClustersComponents != nil {
		in, out := &in.ManagedClustersComponents, &out.ManagedClustersComponents
